...
![prometheus-hpa-service-metrics-1](https://cos.meixuhong.com/imgs/prometheus-hpa-service-metrics-1.png)
...
![prometheus-hpa-service](https://cos.meixuhong.com/imgs/prometheus-hpa-service.png)

通过`/metrics`来查看业务指标：

![prometheus-hpa-service-metrics](https://cos.meixuhong.com/imgs/prometheus-hpa-service-metrics.png)
...
![prometheus-hpa-service-pod](https://cos.meixuhong.com/imgs/prometheus-hpa-service-pod.png)

也可用PromQL语句聚合查看指标：

![prometheus-hpa-service-promql](https://cos.meixuhong.com/imgs/prometheus-hpa-service-promql.png)
...
![prometheus-hpa-service-test](https://cos.meixuhong.com/imgs/prometheus-hpa-service-test.png)
